...
function start(manifest: Manifest, geo: LandmarkGeo) {
  ...
  const theaters = ['pabst-theater','riverside-theater','marcus-campus','saint-kate'].map(name=>city.landmarks.getObjectByName(name));
  ...
  const tourOrder = ['usbank', 'couture', 'mam', 'warmemorial', 'nm', 'lighthouse', 'fiserv', 'turnerhall', 'newmuseum', 'cityhall', 'marcus', 'peck', 'saintkate', 'pabst', 'bmo', 'riverside', 'market', 'thirdward', 'marquette', 'domes', 'amfam', 'basilica', 'hoan', 'port', 'summerfest', 'discovery'];
  ...
  const walkOffsets:Record<string,[number,number]>={
    saintkate:[-12,-43],marcus:[72,-8],peck:[30,15],pabst:[10,30],riverside:[7,36],turnerhall:[-32,0],fiserv:[132,15],thirdward:[20,20],market:[-35,25],mam:[-65,50],
